...
export default function InsightDashboard() {
  // Estado para alternar o cliente atual caso queira gerenciar mais de um no futuro
    ...
    <div className="min-h-screen bg-[#0B0A10] text-gray-100 p-4 md:p-8 font-sans">
      ...
      <div className="bg-[#15131D] border border-gray-800 rounded-2xl p-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 pb-4 border-b border-gray-800 gap-4">
          <div>
            <h2 className="text-lg font-bold text-white flex items-center gap-2">
              ...
              Jornada de Valor do Cliente (Funil Vertical de 8 Estágios)
            </h2>
        ...
        <div className="space-y-4">
          ...
          <div className="w-full bg-[#1B1824] border border-gray-800 rounded-xl p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
            ...
            <div className="flex items-center gap-6">
              <div className="text-right">
                <span className="text-lg font-bold text-white">142.800</span>
              ...
              <div className="text-right">
                ...
                <span className="text-xs text-white block">R$ 8,72</span>
              </div>
            </div>
          </div>

          <div className="text-center text-xs text-purple-400 font-medium py-1">
            ↓ 20.0% taxa de conversão para engajamento
          </div>

          {/* Estágio 2 */}
          <div className="w-[92%] mx-auto bg-[#1B1824] border border-gray-800 rounded-xl p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
            ...
            <div className="flex items-center gap-6">
              <div className="text-right">
                ...
                <span className="text-xs text-gray-400 block">engajes reais (20.0% do topo)</span>
              </div>
              <div className="text-right">
          ...
          <div className="text-center text-xs text-purple-400 font-medium py-1">
            ↓ 15.0% conversão para cliques e interesse de catálogo
          </div>

          {/* Estágio 3 */}
          <div className="w-[84%] mx-auto bg-[#1B1824] border border-gray-800 rounded-xl p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
            ...
            <div className="flex items-center gap-6">
              <div className="text-right">
                ...
                <span className="text-xs text-gray-400 block">leads (15.0% convertido)</span>
              </div>
              <div className="text-right">
          ...
          <div className="text-center text-xs text-purple-400 font-medium py-1">
            ↓ 20.0% Conversão Direta • Transação Concluída
          </div>
          ...
          <div className="w-[84%] mx-auto bg-[#1B1824] border border-gray-800 rounded-xl p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[10px] uppercase tracking-wider text-purple-300 bg-purple-500/20 px-2 py-0.5 rounded font-bold">ESTÁGIO 04 • CONVERSÃO REAL • "VOU COMPRAR"</span>
          ...
          <div className="text-center text-xs text-purple-400 font-medium py-1">
            ↓ 90.0% taxa de satisfação extrema (NPS 94)
          </div>

          {/* Estágio 5 */}
          <div className="w-[68%] mx-auto bg-[#1B1824] border border-gray-800 rounded-xl p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-xs text-gray-400">Superação de expectativas com atendimento excepcional, rapidez e benefícios exclusivos.</p>
            </div>
            <div className="flex items-center gap-6">
              <div className="text-right">
          ...
          <div className="text-center text-xs text-purple-400 font-medium py-1">
            ↓ 50.0% recompra em até 45 dias
          </div>

          {/* Estágio 6 */}
          <div className="w-[60%] mx-auto bg-[#1B1824] border border-gray-800 rounded-xl p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <span className="text-[10px] uppercase tracking-wider text-gray-400 bg-gray-800 px-2 py-0.5 rounded font-medium">Estágio 06 • Retenção & LTV • "Quero mais"</span>
              <h3 className="text-sm font-bold text-white mt-1">6. Expansão</h3>
              <p className="text-xs text-gray-400">Recompra consistente, upgrade de pacotes e ampliação do valor do cliente (LTV).</p>
            </div>
            <div className="flex items-center gap-6">
              <div className="text-right">
          ...
          <div className="text-center text-xs text-purple-400 font-medium py-1">
            ↓ 60.0% taxa de geração de prova social ativa
          </div>

          {/* Estágio 7 */}
          <div className="w-[52%] mx-auto bg-[#1B1824] border border-gray-800 rounded-xl p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <span className="text-[10px] uppercase tracking-wider text-gray-400 bg-gray-800 px-2 py-0.5 rounded font-medium">Estágio 07 • Prova Social • "Eu recomendo"</span>
              <h3 className="text-sm font-bold text-white mt-1">7. Defesa</h3>
              <p className="text-xs text-gray-400">Depoimentos espontâneos, avaliações positivas e compartilhamento de histórias de sucesso.</p>
            </div>
            <div className="flex items-center gap-6">
              <div className="text-right">
          ...
          <div className="text-center text-xs text-purple-400 font-medium py-1">
            ↓ 40.0% Conversão • Embaixadores Ativos Fiéis
          </div>

         {/* Estágio 8 */}
          <div className="w-[45%] mx-auto bg-gradient-to-r from-purple-950/40 via-[#1B1824] to-[#1B1824] border border-purple-500/50 rounded-xl p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-lg">
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[10px] uppercase tracking-wider text-purple-300 bg-purple-500/20 px-2 py-0.5 rounded font-bold">ESTÁGIO 08 • ADVOCACIA & EMBAIXADORES VIP • "EU INDICO"</span>
                <span className="text-[10px] bg-emerald-500 text-black px-2 py-0.5 rounded font-bold">Ativo Recorrente</span>
              </div>
              <h3 className="text-sm font-bold text-white mt-1">8. Promoção</h3>
              <p className="text-xs text-gray-400">Transformação de clientes em embaixadores ativos através de programa de indicação estruturado.</p>
            </div>
            <div className="flex items-center gap-6">
              <div className="text-right">
              ...
              <div className="text-right">
                <span className="text-xs text-purple-400 font-semibold">Novas Vendas</span>
                <span className="text-xs text-white block">184 pcts</span>
              </div>
            </div>
          </div>
